...
async def run(app: FastAPI):
    ...
    recognitionService = RecognitionService(detection_mode=False,access_grantor=access_grantor,database_manager=databaseManager,eventConnectionService=eventConnectionService)
